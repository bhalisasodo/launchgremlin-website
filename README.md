...
The application is configured to run fully client-side and can be hosted on static hosting solutions such as GitHub Pages.

## CI Workflow

This repository includes a GitHub Actions workflow in [.github/workflows/ci.yml](.github/workflows/ci.yml) that runs lint checks and the production build on pushes and pull requests.

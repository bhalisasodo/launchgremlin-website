...
export default function LongTailPage({ slug, onOpenBooking, onSelectTab }) {
  ...
  return (
    <div className="space-y-20 pb-20 select-none">
      ...
      <section aria-labelledby="lt-benefits-title" className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {siblingPages.map((sib) => (
            <a
              ...
              className="p-3.5 rounded-2xl bg-zinc-900/60 border border-zinc-800 hover:border-emerald-400/50 hover:text-emerald-300 transition-all text-center space-y-1.5 flex flex-col items-center justify-center group cursor-pointer"
            >

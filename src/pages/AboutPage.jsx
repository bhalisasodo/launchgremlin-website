...
export default function AboutPage({ onOpenBooking, onSelectTab }) {
  ...
  return (
    <div className="space-y-24 pb-20 select-none">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
              <button
                ...
                aria-label="Build with LaunchGremlin"
      ...
      <section aria-labelledby="build-loop-title" className="max-w-7xl mx-auto px-6 space-y-8">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <span className="text-xs font-mono text-emerald-400 font-bold uppercase tracking-widest block">
            Our Operating Philosophy
          </span>
          <h2 id="build-loop-title" className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight uppercase">
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <h3 className="text-xs font-extrabold text-white font-mono uppercase">{step.name}</h3>
                </div>
      ...
      <section aria-labelledby="manifesto-title" className="max-w-7xl mx-auto px-6 space-y-10">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <span className="text-xs font-mono text-emerald-400 font-bold uppercase tracking-widest block">
            The LaunchGremlin Code
          </span>
          <h2 id="manifesto-title" className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight uppercase">
            How We Think & Build
          </h2>
          <p className="text-xs sm:text-sm text-zinc-400 font-light">
      ...
      <section aria-labelledby="difference-title" className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <h2 id="difference-title" className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-tight uppercase">
            WE BUILD LIKE <br />
      ...
      {/* ---------------- 5. CULTURAL COMMANDMENTS BANNER ---------------- */}
      <section aria-labelledby="commandment-title" className="max-w-7xl mx-auto px-6">
        <div className="p-8 rounded-3xl bg-zinc-900/90 border border-emerald-400/30 backdrop-blur-2xl text-center space-y-4 shadow-[0_0_50px_rgba(52,211,153,0.12)]">
          ...
          <h2 id="commandment-title" className="text-2xl sm:text-3xl font-black text-white tracking-tight font-mono uppercase">
      ...
      <section aria-labelledby="about-cta-title" className="max-w-4xl mx-auto px-6">
        <div className="p-10 sm:p-14 rounded-3xl bg-zinc-900/90 border border-emerald-400/40 backdrop-blur-2xl text-center space-y-6 shadow-[0_0_60px_rgba(52,211,153,0.18)] relative overflow-hidden">
          ...
          <h2 id="about-cta-title" className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight relative z-10 uppercase">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
            <button
              onClick={onOpenBooking}
              aria-label="Build with us strategy call"

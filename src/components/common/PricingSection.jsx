...
export default function PricingSection({ onOpenBooking, onSelectTab }) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 space-y-20 py-12 select-none">
      ...
      <div className="max-w-4xl mx-auto p-6 sm:p-8 rounded-3xl bg-zinc-900/80 border border-emerald-400/40 backdrop-blur-2xl shadow-[0_0_35px_rgba(52,211,153,0.15)] flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left relative overflow-hidden">
        {/* Ambient Glow */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
        ...
        {/* PACKAGE 01: LAUNCH */}
        <div className="p-8 rounded-3xl bg-zinc-900/80 border border-zinc-800 hover:border-emerald-400/50 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-300 flex flex-col justify-between h-full space-y-8">
        ...
        <div className="p-8 rounded-3xl bg-zinc-900 border-2 border-emerald-400 hover:-translate-y-1 shadow-[0_0_50px_rgba(52,211,153,0.2)] transition-all duration-300 flex flex-col justify-between h-full space-y-8 relative">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-emerald-400 font-mono tracking-tight">R9,999</span>
              </div>
              <p className="mt-3 text-xs text-zinc-300 font-light leading-relaxed">
          ...
          <button
            onClick={onOpenBooking}
            className="w-full inline-flex items-center justify-center gap-2 py-4 px-6 rounded-2xl bg-emerald-400 text-zinc-950 font-extrabold text-xs uppercase tracking-wider shadow-[0_0_25px_rgba(52,211,153,0.4)] hover:bg-emerald-300 transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
          >
